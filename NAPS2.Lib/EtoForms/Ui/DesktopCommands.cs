...
public class DesktopCommands
{
        ...
        DesktopFormProvider desktopFormProvider)
    {
        ...
        SaveAllByGroup = new ActionCommand(imageListActions.SaveAllByGroupAsPdf)
        {
            Text = "Save All by Group",
            IconName = "diskette"
        };
        ...
        DocumentIndex = new ActionCommand(desktopSubFormController.ShowDocumentIndexForm)
        {
    ...
    public ActionCommand SaveAllByGroup { get; set; }
    ...
    public ActionCommand DocumentIndex { get; set; }
